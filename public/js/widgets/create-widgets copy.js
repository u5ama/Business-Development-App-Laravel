        ...
        switch (selected_widget_name) {
            case "Slider":
                ...
                for (let index = 0; index < data.length; index++) {
                    ...
                    if (data[index].type == "Tripadvisor") {
                        ...
                        reviewsource = '<span><i class="fab fa-yelp text-right"></i></span>';
                    } else if (data[index].type == "Google Places") {
                        reviewsource = '<span><i class="fab fa-google text-right"></i></span>';
                    }
            ...
            case "MultiSlider":
                ...
                for (let index = 0; index < data.length; index += 3) {
                    ...
                    if (data[col2]) {
                        ...
                        htmlcol2 += '<div class="col-md-4 m-t-30">' +
                        '<div class="container rounded shadow mb-3 p-3">' +    
                            '<div class="text-center">' +        
                                '<img src="http://localhost/trustyy/public/images/avatardp.png" alt="" class="rounded-circle"style=" width: 60px;height: 60px;position: relative;top: -40px;">' +            
                            ...
                            '<div class="row">' +  
                                ...
                                '<div class="col-md-12">' +            
                                    '<div class="three-multi-review quote_font_color review-column text-center">' +                
                                        '<p> "';
                                        htmlcol2 += data[index].message ? data[index].message : 'No review for this user.';
                                        htmlcol2 += '"</p>' +
                                    '</div>' +                
                                '</div>' +            
                    ...
                    '</div>';
                        ...
                        //                                     '<div class="col-md-6">' +
                        //                                         '<img src="' + avatar + '" alt="" class="ml-1 mt-1 rounded-circle" style="width:40px; height:40px;">' +
                        //                                     '</div>' +
                    ...
                    if (data[col3]) {
                        ...
                        htmlcol3 += '<div class="col-md-4 m-t-30">' +
                                        '<div class="container rounded shadow mb-3 p-3">' +    
                                            '<div class="text-center">' +        
                                                '<img src="http://localhost/trustyy/public/images/avatardp.png" alt="" class="rounded-circle"style=" width: 60px;height: 60px;position: relative;top: -40px;">' +            
                                                '<span style="position: relative; top: -15px;left: -15px;">' +
                                            ...
                                            '<div class="row">' +  
                                                ...
                                                '<div class="col-md-12">' +            
                                                    '<div class="three-multi-review quote_font_color review-column text-center">' +                
                                                        '<p> "';
                                                        htmlcol3 += data[index].message ? data[index].message : 'No review for this user.';
                                                        htmlcol3 += '"</p>' +
                                                    '</div>' +                
                                                '</div>' +            
            ...
            case "SingleQuote":
                ...
                for (let index = 0; index < data.length; index++) {
                    ...
                    if (data[index].type == "Tripadvisor") {
                        reviewsource =
                            '<i class="fab fa-tripadvisor text-right"></i>';
                    } else if (data[index].type == "Yelp") {
                        reviewsource = '<i class="fab fa-yelp text-right"></i>';
                    } else if (data[index].type == "Google Places") {
                        reviewsource = '<i class="fab fa-google text-right"></i>';
                    }
...
$(document).ready(function () {
    ...
    $("#background_color").change(function () {
        ...
        switch (selected_widget_name) {
            case "Slider":
                $('#preview_card').css("background-color", this.value);
                break;
            case "MultiSlider":
                $('#preview_card #multislider_carousel > .carousel-inner > .carousel-item > .row > .col-md-4 > .shadow').css("background-color", this.value);
                break;
            case "List":
                $('#preview_card #list_widget .row .col-md-12').css("background-color", this.value);
                break;
            case "Grid":
