...
<div style="padding: 50px; background-color: #edf1f5; font-family: 'Open Sans', sans-serif; color: #6a6a6a;">
    ...
    <div style="max-width: 650px; background-color: #fff; box-sizing: border-box; margin: 23px auto auto; padding: 50px 46px;">
        ...
        Hi there!
        <br/>
        <p>We hope that you find our free scan service useful. To view the Analysis Report we created for your business, <a href="{{ $redirectLink }}">click here.</a></p>
        <p>NetBlaze can provide you more value than just scanning and analyzing your business. We'll create a marketing solution for your business that is simple, easy and automated that will bring you more customers. Trial it out Free here, <a href="{{ $signupUrl }}">click here.</a> </p>
        <p>Regards,
            <br/>Customer Support - <a href="mailto:support@netblaze.com" target="_top">support@netblaze.com</a>
