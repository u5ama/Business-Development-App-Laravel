...
<div class="modal fade add-contact-step1" id="addCustomerStep1" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <div class="st-1-header">
                ...
                <div class="tip-label <?php echo  strtolower($enable_get_reviews)=='enabled'? 'hide': '';?>">
                    {{--<i class="fa fa-lightbulb-o"></i><label>Tip: Increase your Reviews and Rating by sending review requests. <a href="{{ route('crm-customers-settings') }}">Click
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <button id="add-single-customer-next-step" type="button"
...
<div class="modal fade add-contact-step1" id="addCustomerStep2" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
...
<div class="modal fade add-contact-step1" id="addMultipleCustomerStep1" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="st-2-header">
                    ...
                    <div class="step-body">
                        ...
                        <div class="download-csv-section">
                            ...
                            <div class="download-link">
                                <a href="https://dev-app.netblaze.com/public/files/customers_template.csv"
            ...
            <div class="modal-footer step3">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <button id="showAddMultipleCustomerStep2Modal" type="button"
...
<div class="modal fade add-contact-step1" id="addMultipleCustomerStep2" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{--            <div class="modal-header">--}}
            ...
            <div class="modal-footer step3">
                <div class="row">
                    <div class="col-sm-12">
                        <button type="button" id="backToAddMultipleCustomerStep1Modal"
                            class="btn btn-cancel">Back</button>
                        <button id="showAddMultipleCustomerStep3Modal" type="button"
...
<div class="modal fade add-contact-step1" id="addMultipleCustomerStep3" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{--            <div class="modal-header">--}}
                            ...
                            <div id="drop-files" ondragover="return false">
                                ...
                                <div class="upload-link">
                                    ...
                                    <label>or <span>browse<form id="fileUploadForm"><input type="file" name="file"
                                                    id="uploadCustomersCSVFile" style="display: none;"></form></span> to
                                        choose a file</label>
            ...
            <div class="modal-footer step3">
                <div class="row">
                    <div class="col-sm-12">
                        <button type="button" id="backToAddMultipleCustomerStep2Modal"
                            class="btn btn-cancel">Back</button>
...
<div class="modal fade add-contact-step1" id="customerInfoModel" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel">
                        ...
                        <div class="user-details">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="inputContainer-name">
                                        ...
                                        <input type="text" placeholder="First Name"
                                            class="form-control customerFirstName" name="email" value="">
                                ...
                                <div class="col-md-6">
                                    <div class="inputContainer-name">
                                        <div class="bg-divider"></div>
                                        <input type="text" placeholder="Last Name" class="form-control customerLastName"
                                            name="email" value="">
                                        <span class="help-block hide-me">
                                            <strong></strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="inputContainer-mail">
                                        <div class="bg-divider"></div>
                                        <input type="email" class="form-control customerInfoEmail"
                                ...
                                <div class="col-md-6">
                                    <div class="inputContainer-phone">
                                        <div class="bg-divider"></div>
                                        <input type="text" class="form-control customerInfoPhone"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-customer-update btn-block btn-customerupdate"
                            ...
                            <div id="drop-files-section" ondragover="return false">
                                ...
                                <div class="upload-link">
                                    ...
                                    <label>or <span>browse<form id="fileUploadInterfaceForm"><input type="file"
                                                    name="file" id="uploadCustomersFile" style="display: none;"></form>
