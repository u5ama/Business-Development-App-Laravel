...
@section('content')
    <div class="app-content customers-list">
        <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="d-flex mb-30" style="align-items: baseline;" id="res-box">
                                <div class="d-flex" style="align-items: baseline"><h1 class="m-0">Customers</h1> <span class="text-muted text-nowrap">&nbsp; <span id="total_customers">0</span> Total</span></div>
...
{{--                                            <span class="closeSearch hide"><i class="fa fa-times" aria-hidden="true"></i></span>--}}
                                    ...
                                    <button id="upload_CSV_button" class="btn btn-primary">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        ...
                                        <table id="customers-list" class="custom-table table text-nowrap customer-view-table" style="border: none;">
                                            <thead>
                                                <tr>
                                                <th></th>
                                                <th>
