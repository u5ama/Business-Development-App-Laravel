...
class Recipient extends Model
{
    ...
    protected $fillable = [
        'email', 'first_name', 'last_name', 'smart_routing', 'user_id', 'varification_code', 'phone_number', 'country', 'country_code', 'birthmonth', 'birthdate', 'ref_user_id', 'user_ref_id', 'created_at', 'updated_at'
    ];
